...
class CSerialRecvThread : public CThread
{
	...
	CEvent									m_cRecvResponseEvent;			// シリアル受信応答イベント
	CMutex									m_cRecvResponseListMutex;		// シリアル受信応答リスト用ミューテックス
	std::list<RECV_RESPONCE_TABLE>			m_RecvResponseList;				// シリアル受信応答リスト
